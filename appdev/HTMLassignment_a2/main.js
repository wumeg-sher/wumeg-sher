...
tableH2.textContent = "Monthly Site Visitors";
table.appendChild(tableH2);
...
footerH2.textContent = "Website cookie usage";
...
//setting cookie button
let accepted = false; 
cookieLink.addEventListener("click", changeState);
function changeState (event) {
    if (accepted == false){
        cookieText.textContent = "Cookies have been accepted. Would you like to revoke?"
        cookieLink.textContent = "Revoke cookies"
        accepted = true
    }
...
let buttonSection = document.querySelector("#toggle");
let button = document.createElement("a");
button.textContent = "Toggle accessibility mode";
button.href = "#";
buttonSection.appendChild(button);



//setting accessibilty mode toggle
...
//accessibility mode keyboard shortcut
